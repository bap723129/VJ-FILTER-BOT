...
API_ID = int(environ.get('API_ID', '22892256'))
API_HASH = environ.get('API_HASH', '2eec1519a1ceea3f7bbfccca0de5acf5')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002627559408').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', 'moviesdownloadhelp')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '1002647613724')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mahatobibek221034:FA1aFnrrZJH1j65U@cluster0.qalogrz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviesdownloadhelp')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/anime_bp')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviesdownloadhelp') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', '@DarkWorld008')
